...
//                JMeterUtils.initLogging();
                ...
                beanShellSampler.setScript("System.out.println(\"1\")");
                beanShellSampler.setProperty(TestElement.TEST_CLASS, BeanShellSampler.class.getName());
                beanShellSampler.setProperty(TestElement.GUI_CLASS, BeanShellSampler.class.getName());

                // Loop Controller 循环控制
                LoopController loopController = new LoopController();
                loopController.setLoops(12);
